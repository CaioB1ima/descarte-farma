# descarte-farma
Aplicativo móvel para auxiliar no descarte correto de medicamentos vencidos ou não utilizados, protegendo o meio ambiente e a saúde pública através da geolocalização de pontos de coleta.
...
A interface do aplicativo foi projetada para ser clara, moderna e fácil de usar, com um mapa centralizado e informações de pontos de coleta acessíveis. A paleta de cores principal utiliza tons de vermelho vinho e branco, conferindo um visual sofisticado e distinto. Abaixo, uma prévia do design da tela de detalhes, com a funcionalidade de visualização 360°:
